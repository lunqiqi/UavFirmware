...
bool mpu6500Init(I2C_Dev *i2cPort)
{
	...
	i2cdevWriteByte(I2Cx, devAddr, MPU6500_RA_PWR_MGMT_1,0x80);	/*��λMPU*/
	i2cdevWriteByte(I2Cx, devAddr, MPU6500_RA_PWR_MGMT_1,0x80);	/*��λMPU*/
	
	delay_xms(50);
	i2cdevReadByte(I2Cx, devAddr, MPU6500_RA_WHO_AM_I, &temp);	/*��ȡID*/
	...
	i2cdevWriteByte(I2Cx, devAddr, MPU6500_RA_INT_ENABLE,0x0);		/*�ر��ж�*/
	i2cdevWriteByte(I2Cx, devAddr, MPU6500_RA_INT_PIN_CFG,0x02);	/*ʹ��I2C BYPASS*/
	i2cdevWriteByte(I2Cx, devAddr, MPU6500_RA_GYRO_CONFIG,MPU6500_GYRO_FS_2000<<3);	/*���������̡�2000*/
	i2cdevWriteByte(I2Cx, devAddr, MPU6500_RA_ACCEL_CONFIG,MPU6500_ACCEL_FS_8<<3);	/*���ټ����̡�8G*/
	i2cdevWriteByte(I2Cx, devAddr, MPU6500_RA_SMPLRT_DIV,1);				/*��������(1000/(1+1)=500Hz)*/
	i2cdevWriteByte(I2Cx, devAddr, MPU6500_RA_CONFIG,MPU6500_DLPF_BW_98);	/*���ֵ�ͨ�˲�������*/
