...
bool ak8963SelfTest(void);	/*AK8963�Լ�*/

uint8_t ak8963GetDeviceID(void);	// WIA �Ĵ���
uint8_t ak8963GetInfo(void);		// INFO �Ĵ���
uint8_t ak8963GetDataReady(void);	// ST1 �Ĵ���
...
bool ak8963GetOverflowStatus(void);// ST2 �Ĵ���
bool ak8963GetDataError(void);

uint8_t ak8963GetMode(void);// CNTL �Ĵ���
void ak8963SetMode(u8 mode);
void ak8963Reset(void);

void ak8963SetSelfTest(bool enabled);// ASTC �Ĵ���
